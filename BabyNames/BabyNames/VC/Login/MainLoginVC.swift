...
//                iphone x
            ...
            let myAttribute = [ NSAttributedString.Key.foregroundColor: UIColor(hex: Constants.Colors.NavBarBGColor.rawValue)]
            let myAttribute2 = [ NSAttributedString.Key.foregroundColor: UIColor(hex: Constants.Colors.subTitleColorF.rawValue)]
