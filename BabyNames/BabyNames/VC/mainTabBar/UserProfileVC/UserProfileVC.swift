...
//            changeBabyGender
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 0:
            // logOut
            // create the alert
            let alert = UIAlertController(title: AppStrings.LOGOUT_GOODBYE, message: AppStrings.LOGOUT_MESSAGES, preferredStyle: UIAlertController.Style.alert)
            // add the actions (buttons)
            alert.addAction(UIAlertAction(title: AppStrings.LOG_OUT, style: UIAlertAction.Style.destructive, handler: { action in
