...
public extension Bundle {
    ...
    /**
     ...
     - returns: dictionary of values
     */
    public static func contentsOfFile(bundleURL: NSURL, plistName: String = "MyData.plist") -> [String : AnyObject] {
    ...
    /**
     ...
     - returns: dictionary of values
     */
    public static func contentsOfFile(bundleName: String, plistName: String = "MyData.plist") -> [String : AnyObject] {
    ...
    /**
     ...
     - returns: dictionary of values
     */
    public static func contentsOfFile(bundle: Bundle, bundleName: String = "Settings", plistName: String = "MyData.plist") -> [String : AnyObject] {
